...
export default function Home() {
  ...
  const [redirectPackage, setRedirectPackage] = useState(null);
      ...
      let data = [
        {
          ...
          name: "Ejemplo App",
          developer: "Dev Team",
          description: "Una aplicación de ejemplo para mostrar resultados.",
        ...
        },
        {
          ...
          description: "Un juego de ejemplo para mostrar la cuadrícula.",
          packageName: "com.juego.demo",
          iconUrl: "https://via.placeholder.com/60",
          rating: 4.8,
          downloads: 500000,
          category: "game",
  ...
  const redirectToDownload = (pkg) => {
    setRedirectPackage(pkg);
  ...
  return (
    <div className="package-finder">
      ...
      <style jsx>{`
        ...
        .package-search-container button {
          background: #4285f4;
          color: white;
          padding: 10px 20px;
          border: none;
